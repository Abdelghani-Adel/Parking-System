...
import cardCategoryList from "@/public/data/card-category-list.json";
...
import TicketCategoryForm from "../forms/TicketCategoryForm";
...
const CardCategoryTable = () => {
  ...
  const columnOrder = transformRecordsToTable(cardCategoryList, ["id", "name", "fees", "parkingName"]);
        ...
        customBodyRender: (value: any, tableMeta: any) => {
          ...
          return (
            <ActionsColumn
              ...
              setSelectedData={(data) => setSelectedCategory(data)}
    ...
    <>
      ...
      <Sheet open={isEditing} onOpenChange={setIsEditing}>
        <SheetContent className="sm:max-w-full w-[600px] overflow-auto">
          <SheetHeader>
            <SheetTitle>Editing Ticket Category</SheetTitle>

            <TicketCategoryForm onSubmit={() => {}} id={"1"} />
          </SheetHeader>
        </SheetContent>
      </Sheet>
      ...
      <Sheet open={isAdding} onOpenChange={setIsAdding}>
        <SheetContent className="sm:max-w-full w-[600px] overflow-auto">
          <SheetHeader>
            <SheetTitle>Adding Ticket Category</SheetTitle>

            <TicketCategoryForm onSubmit={() => {}} />
          </SheetHeader>
        </SheetContent>
      </Sheet>
      ...
      <AlertDialog open={isSuspending} onOpenChange={setIsSuspending}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>You are suspending this Ticket Category</AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
      ...
      <AlertDialog open={isDeleting} onOpenChange={setIsDeleting}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Are you Sure?</AlertDialogTitle>
            <AlertDialogDescription>You are deleting this Ticket Category</AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel>Cancel</AlertDialogCancel>
