...
const StoredValueCardForm: React.FC<Iprops> = ({ id, onSubmit }) => {
  const form = useForm();
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
      ...
      <div>
        ...
        <Controller
          ...
          control={control}
          render={({ field }) => (
            <Select value={field.value} onValueChange={field.onChange} disabled defaultValue="subscription">
...
export default StoredValueCardForm;
