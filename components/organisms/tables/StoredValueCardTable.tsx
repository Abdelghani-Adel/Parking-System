...
import cardList from "@/public/data/storedValue-card-list.json";
...
import StoredValueCardForm from "../forms/StoredValueCardForm";

const StoredValueCardTable = () => {
      ...
      <Sheet open={isEditing} onOpenChange={setIsEditing}>
        <SheetContent className="w-96 overflow-auto">
          <SheetHeader>
            ...
            <StoredValueCardForm onSubmit={() => {}} id={"1"} />
          </SheetHeader>
        </SheetContent>
      </Sheet>
...
export default StoredValueCardTable;
