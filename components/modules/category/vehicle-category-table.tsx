...
import categories from "./vehicle-category-date.json";
import { IoMdAddCircle } from "react-icons/io";
import VehicleCategoryForm from "./vehicle-category-form";

const VahicleCategoryTable = () => {
      ...
      <Sheet open={isEditing} onOpenChange={setIsEditing}>
        <SheetContent className="sm:max-w-full w-[600px] overflow-auto">
          <SheetHeader>
            ...
            <VehicleCategoryForm mode="edit" onSubmit={() => {}} initialValues={selectedCategory} />
          </SheetHeader>
        </SheetContent>
      </Sheet>
      ...
      <Sheet open={isAdding} onOpenChange={setIsAdding}>
        <SheetContent className="sm:max-w-full w-[600px] overflow-auto">
          <SheetHeader>
            ...
            <VehicleCategoryForm mode="add" onSubmit={() => {}} />
          </SheetHeader>
        </SheetContent>
      </Sheet>
...
export default VahicleCategoryTable;
